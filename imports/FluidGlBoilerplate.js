 ...
 */
const compileShader = function(gl, shaderSource, shaderType) {
 ...
 */
const createShaderFromScript = function(gl, scriptId, opt_shaderType) {
 ...
 * @return {!WebGLProgram} A program
 */
export const createProgramFromScripts = function(
